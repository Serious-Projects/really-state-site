...
function PropertyDetails() {
	...
	const { data, isLoading, isError } = useOne({ resource: 'properties', id: id as string });
			...
			<Box mt="20px" display="flex" flexDirection={{ xs: 'column', lg: 'row' }} gap={4}>
				<Box flex={1} maxWidth={764}>
					...
					<Box mt="15px">
						...
						<Stack direction="row" justifyContent="space-between" flexWrap="wrap" alignItems="center" gap={2}>
							<Box>
								<Typography fontSize={22} fontWeight={600} mt="10px" color="#11142d" textTransform="capitalize">
				...
				<Box width="100%" flex={1} maxWidth={326} display="flex" flexDirection="column" gap="20px">
					...
					>
						...
						<Stack width="100%" mt="15px" direction="row" flexWrap="wrap" gap={2}>
							<CustomButton
							...
							<CustomButton
								...
								backgroundColor={!isCurrentUser ? '#2e8480' : '#d42e2e'}
								color="#fcfcfc"
								fullWidth
